...
def aggregate_unfolded_data(path, colnames, target_df_trainVal, eps, multiple=False, max_train='2013-11-22', max_val='2018-04-10', max_test='2022-12-31', neigh=1, curr_seed = 42, shuffle = False, no_tiny_aggregations = False, exclude_lowcorr=False, shuffle_starting_point_only = False):
